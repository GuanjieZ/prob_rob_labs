...
P_io = []
for element in P_ig:
    P_io.append(simplify(T_om * element))
...
#Hx_simp = Hx.applyfunc(simplify)
Hx_func = lambdify((x, y, theta, t_cx, t_cy, t_cz, x_l, y_l, r_l, h_l, f_x, f_y, c_x, c_y), Hx)

# Example usage of Hx_func
result = Hx_func(1.0, 2.0, 0.5, 0.1, 0.2, 0.3, 4.0, 5.0, 1.2, 3.3, 500, 500, 250, 250)
